...
import 'package:flutter_study/pages/statistics/widgets/selected_text.dart';
import 'package:flutter_study/res/resources.dart';
import 'package:flutter_study/utils/date_utils.dart';
import 'package:flutter_study/utils/date_utils_helper.dart' as date;
...
import 'package:flutter_study/widgets/my_card.dart';
import 'package:common_utils/common_utils.dart';
import 'package:flutter_study/widgets/bezier_chart/bezier_chart.dart';
import 'dart:math';
...
class _OrderStatisticsPageState extends State<OrderStatisticsPage>
  ...
  void initState() {
    ...
    _weeksDays = date.Utils.daysInRange(date.Utils.previousWeek(_initialDay),
            DateUtils.nextDay(_initialDay))
        .toList()
        .sublist(1, 8);
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Gaps.vGap16,
                    _buildChart(Colours.app_main, const Color(0x805793FA),
