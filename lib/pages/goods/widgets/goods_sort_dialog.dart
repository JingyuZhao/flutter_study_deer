...
class GoodsSortDialogState extends State<GoodsSortDialog>
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemExtent: 48.0,
                      itemBuilder: (_, index) {
                        bool flag = provider.mList[index]['name'] ==
                            provider.myTabs[provider.index].text;
                        return InkWell(
                          child: Container(
                          ...
                          onTap: () {
                            provider.myTabs[provider.index] =
                                Tab(text: provider.mList[index]['name']);
                            ...
                            if (provider.index > 2) {
                              provider.setIndex(2);
                              widget.onSelected(provider.mList[index]['id'],
