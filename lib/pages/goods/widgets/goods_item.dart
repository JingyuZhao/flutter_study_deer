...
import 'package:flutter_study/pages/goods/model/goods_item_entity.dart';
import 'package:flutter_study/pages/goods/widgets/menu_reveal.dart';
...
import 'package:flutter_study/widgets/load_image.dart';
...
class GoodsItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Row child = Row(
      ...
      children: <Widget>[
        ExcludeSemantics(
            child: LoadImage(image: item.icon, width: 72.0, height: 72.0)),
        Gaps.hGap8,
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
