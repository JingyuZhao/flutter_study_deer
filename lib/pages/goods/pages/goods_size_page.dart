...
import 'package:flutter_study/pages/goods/model/goods_size_model.dart';
import 'package:flutter_slidable/flutter_slidable.dart';
import 'package:flutter_study/pages/goods/widgets/goods_size_dialog.dart';
          ...
          child: Column(
            ...
            children: <Widget>[
              Row(
                ...
                children: <Widget>[
                  Text(_goodsSizeList[index].sizeName,
                      maxLines: 1, overflow: TextOverflow.ellipsis),
                  Text('库存${_goodsSizeList[index].stock}',
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  Text('佣金${_goodsSizeList[index].charges}元',
                      style: TextStyles.textSize12),
                  Text('起购${_goodsSizeList[index].minSaleNum}件',
                      style: TextStyles.textSize12),
                ],
              )
            ],
