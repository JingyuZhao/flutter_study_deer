...
import 'package:flutter_study/pages/goods/pages/goods_list_page.dart';
...
//                  shouldRebuild: (previous, next) => previous != next,
  ...
  void _showSortMenu() {
    ...
    // 获得控件左下方的坐标
    final Offset a = button.localToGlobal(
        Offset(0.0, button.size.height + 12.0),
        ancestor: overlay);
    // 获得控件右下方的坐标
    final Offset b = button.localToGlobal(
        button.size.bottomLeft(const Offset(0, 12.0)),
        ancestor: overlay);
