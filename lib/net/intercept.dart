...
class TokenInterceptor extends Interceptor {
  ...
  Future<String> getToken() async {
    ...
    try {
      ...
      final Response respone =
          await _tokenDio.post("lgn/refreshToken", data: params);
      if (respone.statusCode == ExceptionHandle.success) {
        return json.decode(respone.data.toString())["access_token"];
      }
    } catch (e) {
      Log.e('刷新Token失败！');
    }
  ...
  Future onResponse(Response response) async {
    ...
    if (response != null &&
      ...
      SpUtil.putString(Constant.accessToken, accessToken); //更新token
